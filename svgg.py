...
def inserting(rectangle,rounded_rectangle,curved_rectangle,Pentagon,host,database,username,password):
    try:
        ...
        cursor = connection.cursor()
        sql_query = "INSERT INTO SVG (rectangle, rounded_rectangle, curved_rectangle, Pentagon ) VALUES (%s,%s, %s, %s);"
...
if __name__ == "__main__":
    ...
    password = "techsol"
    port = "5432"
    svg_file = r"C:\Users\anusha.raparthi\Downloads\Copy (1) of TLS - Gland - Change Control - PFD_2.svg"
    svg_code = read_svg_file(svg_file)
